...
import com.recom3.snow3.activity.trip.details.AbstractDetailsFragment;
...
public class TripDetailsActivity extends AppCompatActivity implements AbstractDetailsFragment.OnBoxDetailsSelectedListener {
    ...
    private void setHeader(TripParcelable tripParcelable) {
        if(mLocation==null)
        {
            mLocation = findViewById(R.id.trip_details_layout_text_view_location);
            mRunNumber = findViewById(R.id.trip_details_layout_text_view_run_number);
            //mRunDescription= findViewById(R.id.trip_details_la);
        }
